...
CREATE  TABLE material_testing.dbo.material_test_results (
                                                             result_id            int    IDENTITY  NOT NULL,
                                                             material_test_id     int      NULL,
                                                             test_name_id         int      NULL,
                                                             user_id              int      NULL,
                                                             requirement          nvarchar(150)      NULL,
                                                             actual               nvarchar(150)      NULL,
                                                             creation_date        datetime2      NULL,
                                                             test_situation       int      NULL,
                                                             CONSTRAINT pk_material_test_report_results PRIMARY KEY CLUSTERED ( result_id  asc )
);
GO
...
ALTER TABLE material_testing.dbo.material_test ADD CONSTRAINT fk_material_test_sections FOREIGN KEY ( section_id ) REFERENCES material_testing.dbo.sections( section_id );
GO

ALTER TABLE material_testing.dbo.material_test ADD CONSTRAINT fk_material_test_supplier_country FOREIGN KEY ( supplier_id, country_id ) REFERENCES material_testing.dbo.supplier_country( supplier_id, country_id );
GO
